 ...
 */
public class CubeGridCompatImageView extends AppCompatImageView {

    private CubeGridManager mCubeGridManager;

    private CubeGridManagerOption.Builder mBuilder;

    public CubeGridCompatImageView(Context context) {
        this(context, null);
    }

    public CubeGridCompatImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void start(final ICubeGridAnimCallback cubeGridAnimCallback) {
        post(new Runnable() {
            ...
            public void run() {
                ...
                getCubeGridManager().startLoop(CubeGridCompatImageView.this);
            }
        });
    }
